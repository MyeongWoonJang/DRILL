...
# Boy Event
RIGHT_DOWN, LEFT_DOWN, RIGHT_UP, LEFT_UP, SLEEP_TIMER, SHIFT_DOWN, SHIFT_UP, DASH_TIMER, DEBUG_KEY, SPACE_DOWN = range(10)
...
next_state_table = {
    IdleState: {RIGHT_UP: RunState, LEFT_UP: RunState, RIGHT_DOWN: RunState, LEFT_DOWN: RunState, SLEEP_TIMER: SleepState,
                SHIFT_DOWN: IdleState, SHIFT_UP: IdleState, SPACE_DOWN: IdleState},
    RunState: {RIGHT_UP: IdleState, LEFT_UP: IdleState, LEFT_DOWN: IdleState, RIGHT_DOWN: IdleState,
               SHIFT_DOWN: DashState, SHIFT_UP: RunState, SPACE_DOWN: RunState},
    SleepState: {LEFT_DOWN: RunState, RIGHT_DOWN: RunState, LEFT_UP: RunState, RIGHT_UP: RunState, SPACE_DOWN: IdleState,
    ...
    DashState: {SHIFT_UP: RunState, DASH_TIMER: RunState, RIGHT_DOWN: IdleState, LEFT_DOWN:IdleState,
                LEFT_UP: IdleState, RIGHT_UP:IdleState, SHIFT_DOWN: DashState, SPACE_DOWN: DashState}
}
    ...
    def update(self):
        ...
        if len(self.event_que) > 0:
            ...
            try:
                ...
                print('Error: State: ' + self.cur_state.__name__ + ' Event: ' + event_name[event])
                exit(-1)
